            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                       Teamtjie is an app that let's you truly understand <br />how your team is feeling.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Track your team's daily sentiment
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:bottom-1/2 before:left-[0.4rem] before:top-0 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            ...
                            <span>
                                Track team health with Health Checks
                            </span>
                        </li>
                    </ul>
                    <ul class="flex gap-3 text-sm leading-normal">
                        ...
                        <template v-else>
                            ...
                            <li>
                                <a
                                    :href="route('login')"
                                    class="inline-block rounded-sm px-5 py-1.5 text-sm leading-normal text-white dark:hover:border-white"
                                >
                                    Login
                                </a>
                            </li>
